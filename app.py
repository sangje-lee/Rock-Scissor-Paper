...
possible_item = ['Scissor', 'Rock', 'Paper'] # Rock, Paper, Scissor is reversed because 
                                             # original code was translated from Korean, 
                                             # ['가위', '바위', '보']
winner_status = ['win', 'lose', 'tie']
possible_winner = ['N/A','Player','Computer']
...
def declare_winner():
    ...
    # final_winner = ['N/A','Player','Computer']
    if player_win == 10:
